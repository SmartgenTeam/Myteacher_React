...
class QuizPracticeResultActivity extends Component {
    ...
    render() {
        return (
            <View style={{ backgroundColor: COLORS.green, height: '100%', width: '100%' }}>
                ...
                <Text style={{ marginTop: 20, padding: 12, alignSelf: 'center', fontSize: 14, color: COLORS.blue, position: 'absolute', fontWeight: 'bold' }} >Practice</Text>
...
export default QuizPracticeResultActivity