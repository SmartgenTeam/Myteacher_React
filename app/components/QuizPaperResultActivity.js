...
class QuizPaperResultActivity extends Component {
    ...
    displayOptions() {
        ...
        console.log(Number(this.state.selectedQuestionData[currPos].correctOption));
...
export default QuizPaperResultActivity