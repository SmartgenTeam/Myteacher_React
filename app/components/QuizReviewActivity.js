...
class QuizReviewActivity extends Component {
    ...
    viewSummary() {
        ...
        this.props.navigation.navigate('summeryReviewActivity', { 'data': this.state.selectedQuestionData, 'questionData': this.state.questionData, 'percentage': (correct * 100) / qData.length, 'correct': correct, 'wrong': qData.length - correct, 'unAnswered': unAnswered })
    }
...
export default QuizReviewActivity