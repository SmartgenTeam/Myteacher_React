...
class SummeryReviewActivity extends Component {
        ...
        return (
            <View style={{ height: '100%', width: '100%' }}>
                ...
                <Image
                    ...
                    source={require('../images/img_page_bg1.png')}
                />
                {/* <Image
                ...
                <Text style={{ marginTop: 50, padding: 12, textAlign: 'left', fontSize: 18, color: COLORS.black, position: 'absolute' }} >Summary</Text>
...
export default SummeryReviewActivity
