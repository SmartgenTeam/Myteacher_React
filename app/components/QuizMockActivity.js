...
class QuizMockActivity extends Component {
    ...
    submitQuiz() {
        ...
        db.insertQuizData(code => {
            ...
            this.props.navigation.replace('summeryMockActivity', { 'data': this.state.selectedQuestionData, 'questionData': this.state.questionData, 'percentage': (correct * 100) / qData.length, 'correct': correct, 'wrong': qData.length - correct, 'unAnswered': unAnswered })
...
export default QuizMockActivity
