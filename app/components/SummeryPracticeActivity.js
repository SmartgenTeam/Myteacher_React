...
class SummeryPracticeActivity extends Component {
                ...
                <View style={{ width: '90%', height: '70%', marginTop: 150, alignSelf: 'center', position: 'absolute', backgroundColor: COLORS.white, elevation: 5, borderRadius: 8 }}>
                    <ScrollView>
                        <View style={{ padding: 10, marginTop: 10 }}>
                            <Text style={{ fontWeight: 'bold', fontSize: 15 }}>{getValue(LABEL.performance, this.state.langId)}</Text>
                            ...
                            <TouchableOpacity
                                ...
                                activeOpacity={0.7}
                                onPress={() => this.props.navigation.replace('quizPracticeResultActivity', { 'data': this.state.data, 'questionData': this.state.questionData })}>
                        ...
                        <View style={{ padding: 10, }}>
                            <Text style={{ fontWeight: 'bold', fontSize: 15 }}>{getValue(LABEL.Score, this.state.langId)}</Text>
                            <View style={{ height: 0.5, width: '100%', backgroundColor: COLORS.darkGrey, marginBottom: 8, marginTop: 4 }}></View>
                            <PieChart
                            ...
                            <View style={{ flexDirection: 'row', marginTop: 15, alignItems: 'center', alignSelf: 'center' }}>
                                ...
                                <Text style={{ fontSize: 12, marginStart: 3 }}>{getValue(LABEL.lightningFast, this.state.langId)}</Text>
                                <View style={{ height: 10, width: 10, backgroundColor: '#43A047', marginStart: 5 }} />
                                <Text style={{ fontSize: 12, marginStart: 3 }}>{getValue(LABEL.perfect, this.state.langId)}</Text>
                                <View style={{ height: 10, width: 10, backgroundColor: '#1E7ECE', marginStart: 5 }} />
                                <Text style={{ fontSize: 12, marginStart: 3 }}>{getValue(LABEL.slowGoing, this.state.langId)}</Text>
                                <View style={{ height: 10, width: 10, backgroundColor: '#FB8C00', marginStart: 5 }} />
                                <Text style={{ fontSize: 12, marginStart: 3 }}>{getValue(LABEL.Incorrect, this.state.langId)}</Text>
                            </View>
                        </View>
                        <View style={{ padding: 10, marginTop: 15 }}>
                            <Text style={{ fontWeight: 'bold', fontSize: 15 }}>{getValue(LABEL.statistics, this.state.langId)}</Text>
                            <View style={{ height: 0.5, width: '100%', backgroundColor: COLORS.darkGrey, marginBottom: 8, marginTop: 4 }}></View>
                            <FlatList
...
export default SummeryPracticeActivity
