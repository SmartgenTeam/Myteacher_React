...
class SummeryTeacherReviewActivity extends Component {
    ...
    render() {
        ...
        return (
            <View style={{ height: '100%', width: '100%' }}>
                ...
                <Text style={{ marginTop: 50, padding: 12, textAlign: 'left', fontSize: 18, color: COLORS.black, position: 'absolute' }} >{getValue(LABEL.summary, this.state.langId)}</Text>
                <View style={{ width: '90%', height: '70%', marginTop: 150, alignSelf: 'center', position: 'absolute', backgroundColor: COLORS.white, elevation: 5, borderRadius: 8 }}>
                    ...
                    <Text style={{ color: COLORS.darkGrey, fontSize: 12, marginStart: 20 }}>{getValue(LABEL.axes, this.state.langId)}</Text>
                    <TouchableOpacity
...
export default SummeryTeacherReviewActivity
