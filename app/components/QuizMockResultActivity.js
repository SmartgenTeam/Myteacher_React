...
class QuizMockResultActivity extends Component {
    ...
    //         url = STRING.baseURL + STRING.getSubjectQuiz + "subjectId=" + this.state.subjectId + "&langId=" + this.state.languageId
    //     } else {
    //         url = STRING.baseURL + STRING.getChapterQuiz + "chapterId=" + this.state.chapterId + "&langId=" + this.state.languageId
    //     }        
    ...
    render() {
        return (
            <View style={{ backgroundColor: COLORS.green, height: '100%', width: '100%' }}>
                ...
                <Text style={{ marginTop: 20, padding: 12, alignSelf: 'center', fontSize: 14, color: COLORS.blue, position: 'absolute', fontWeight: 'bold' }} >Mock Test</Text>
                <View style={GLOBALSTYLE.quizContainer}>
                    {this.state.isLoading
                        ...
                        :
                        <View>
                            {/* <Text style={{ alignSelf: 'center', fontSize: 14, color: COLORS.pink, fontWeight: 'bold' }} >{this.state.chapterName}</Text> */}
                            ...
                            {this.state.isQuestionAvailable ?
                                <View>
                                    ...
                                    />
                                    <ScrollView style={{ width: '100%', height: '88%', marginTop: 60 }}>
...
export default QuizMockResultActivity