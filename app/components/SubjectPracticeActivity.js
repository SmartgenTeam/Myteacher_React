...
class SubjectPracticeActivity extends Component {
    ...
    async openChapter(item) {
        ...
        this.props.navigation.navigate('chapterPracticeActivity', { 'subjectId': item.subjectId, 'subjectName': item.subjectName, 'subjectData': item })
    }
        ...
        return (
            <View style={{ height: '100%', width: '100%' }}>
                ...
                {/* <Image
                    ...
                    source={require('../images/img_bg_practice.png')}
                /> */}
                ...
                <Text style={{ marginTop: 50, padding: 12, textAlign: 'left', fontSize: 18, color: COLORS.blue, position: 'absolute' }} >{getValue(LABEL.practice, this.state.langId)}</Text>
...
export default SubjectPracticeActivity
