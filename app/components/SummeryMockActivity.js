...
class SummeryMockActivity extends Component {
                    ...
                    <ScrollView>
                        <View style={{ padding: 10, marginTop: 10 }}>
                            ...
                            <TouchableOpacity
                                ...
                                activeOpacity={0.7}
                                onPress={() => this.props.navigation.replace('quizMockResultActivity', { 'data': this.state.data, 'questionData': this.state.questionData })}>
...
export default SummeryMockActivity
